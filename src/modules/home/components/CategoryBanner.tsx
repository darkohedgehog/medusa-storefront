...
const categories: CategoryItem[] = [
  ...
  const CategoryBanner: React.FC = () => {
    return (
      <>
        <h3 className='text-2xl ml-7 my-10 text-left'>Izaberi kategoriju</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-4 gap-y-6 pt-10 mx-4 px-4">
